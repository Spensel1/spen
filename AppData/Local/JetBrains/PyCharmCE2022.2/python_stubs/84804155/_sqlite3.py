# encoding: utf-8
# module _sqlite3
# from C:\Users\Win10\AppData\Local\Programs\Python\Python310\DLLs\_sqlite3.pyd
# by generator 1.147
# no doc
...
adapters = {
    (
        ...
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_date at 0x000001DA3977B760>'
    ,
    (
        None, # (!) real value is "<class 'datetime.datetime'>"
        '<value is a self-reference, replaced by this string>',
    ): 
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_datetime at 0x000001DA3977B7F0>'
    ,
}

converters = {
    'DATE': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_date at 0x000001DA3977BD90>'
    'TIMESTAMP': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_timestamp at 0x000001DA3977BEB0>'
}

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DA396D08B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_sqlite3', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DA396D08B0>, origin='C:\\\\Users\\\\Win10\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python310\\\\DLLs\\\\_sqlite3.pyd')"
