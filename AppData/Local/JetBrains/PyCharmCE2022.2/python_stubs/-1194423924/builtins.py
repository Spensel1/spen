...
class classmethod(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFE2F405F50>, '__repr__': <slot wrapper '__repr__' of 'classmethod' objects>, '__get__': <slot wrapper '__get__' of 'classmethod' objects>, '__init__': <slot wrapper '__init__' of 'classmethod' objects>, '__func__': <member '__func__' of 'classmethod' objects>, '__wrapped__': <member '__wrapped__' of 'classmethod' objects>, '__isabstractmethod__': <attribute '__isabstractmethod__' of 'classmethod' objects>, '__dict__': <attribute '__dict__' of 'classmethod' objects>, '__doc__': 'classmethod(function) -> method\\n\\nConvert a function to be a class method.\\n\\nA class method receives the class as implicit first argument,\\njust like an instance method receives the instance.\\nTo declare a class method, use this idiom:\\n\\n  class C:\\n      @classmethod\\n      def f(cls, arg1, arg2, ...):\\n          ...\\n\\nIt can be called either on the class (e.g. C.f()) or on an instance\\n(e.g. C().f()).  The instance is ignored except for its class.\\nIf a class method is called for a derived class, the derived class\\nobject is passed as the implied first argument.\\n\\nClass methods are different than C++ or Java static methods.\\nIf you want those, see the staticmethod builtin.'})"
...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'module_repr': <staticmethod(<function BuiltinImporter.module_repr at 0x0000023006BA2320>)>, 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x0000023006BA23B0>)>, 'find_module': <classmethod(<function BuiltinImporter.find_module at 0x0000023006BA2440>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x0000023006BA24D0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x0000023006BA2560>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x0000023006BA2680>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x0000023006BA27A0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x0000023006BA28C0>)>, 'load_module': <classmethod(<function _load_module_shim at 0x0000023006BA17E0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
