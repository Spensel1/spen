# encoding: utf-8
# module pygame.image
# from C:\Users\Win10\AppData\Local\Programs\Python\Python310\lib\site-packages\pygame\image.cp310-win_amd64.pyd
# by generator 1.147
...
def frombuffer(bytes, size, format): # real signature unknown; restored from __doc__
    """
...
def get_sdl_image_version(): # real signature unknown; restored from __doc__
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A7B64D1DB0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pygame.image', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A7B64D1DB0>, origin='C:\\\\Users\\\\Win10\\\\PycharmProjects\\\\pythonProject\\\\venv\\\\lib\\\\site-packages\\\\pygame\\\\image.cp310-win_amd64.pyd')"
